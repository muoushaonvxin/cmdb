...
class Asset(object):
    ...
    def _create_server(self):
        ...
        log_msg = "Asset [<a href='/admin/assets/asset/%s/' target='_blank'>%s</a>] has been created!" % (self.asset_obj.id,
                                                                                                          self.asset_obj
                                                                                                          )
    ...
    def __compare_component(self, model_obj, fields_from_db, data_source):
        ...
        for field in fields_from_db:
            ...
            if val_from_data_source:
                ...
                self.response_msg('warning',
                                  'AssetUpdateWarning',
                                  "Asset component [%s]'s field [%s] is not provided in reporting data " % (model_obj, field)
                                  )
