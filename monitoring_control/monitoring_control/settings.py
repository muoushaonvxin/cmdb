"""
Django settings for monitoring_control project.
...
SECRET_KEY = '8)5wwijym+md0msmg)9k++uoqx2#a9^7jr_cm(dn2d^%9vxxt3'
...
ROOT_URLCONF = 'monitoring_control.urls'
...
WSGI_APPLICATION = 'monitoring_control.wsgi.application'
